<?php
	...
	if(!$Email->Send()) {
		echo '<div class="alert error"><strong>Oops</strong>, um erro foi encontrado. Por favor, tente novamente.</div>';
	}
	else {
		echo '<div class="alert success"><strong>Obrigado</strong> pela sua mensagem!</div>';
	}
