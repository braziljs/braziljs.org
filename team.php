<?php include 'header.php' ?>
  ...
  <article class="team single-page">
    ...
    <ul>
      ...
      <li>
        <a href="http://twitter.com/davidsonFellipe" target="_blank"><img src="img/avatar/davidson.jpg" alt="Davidson Fellipe"></a>
        ...
        <p class="description">Founder and moderator of RioJS and PernambucoJS (JS user groups), graduated in Computer Engineering at UPE. Currently is Front-end engineer at Globo.com and Master degree Candidate at PUC-Rio.</p>
      </li>
      <li>
        <a href="http://twitter.com/felipenmoura" target="_blank"><img src="img/avatar/felipe.jpg" alt=""></a>
        <p class="name"><a href="http://twitter.com/felipenmoura" target="_blank">Felipe N. Moura</a></p>
        <p class="position">National Conference Lead</p>
        <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vitae orci eget dui semper consectetur. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vitae orci eget dui semper.</p>
      </li>
      <li>
      ...
      <li>
        <a href="http://twitter.com/leobalter" target="_blank"><img src="img/avatar/leo.jpg" alt=""></a>
        <p class="name"><a href="http://twitter.com/leobalter" target="_blank">Leo Balter</a></p>
        <p class="position">Community Blog Lead</p>
        <p class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vitae orci eget dui semper consectetur. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vitae orci eget dui semper.</p>
      </li>
      <li>
        <a href="http://zenorocha.com/" target="_blank"><img src="img/avatar/zeno.jpg" alt=""></a>
        <p class="name"><a href="http://zenorocha.com/" target="_blank">Zeno Rocha</a></p>
        <p class="position">Community Relations Lead</p>
